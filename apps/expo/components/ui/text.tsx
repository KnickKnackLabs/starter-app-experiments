// biome-ignore lint/performance/noNamespaceImport: Required by @rn-primitives/slot API
...
function Text({
  ...
  return (
    <Component
      // biome-ignore lint/nursery/noLeakedRender: React Native Reusables pattern
